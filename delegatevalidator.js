...
// console.log(LOCALNET_CHAIN.chainId,LOCALNET_CHAIN.cosmosChainId);
// LOCALNET_CHAIN.chainId=9000
// LOCALNET_CHAIN.cosmosChainId= "evmos_9000-2"
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    types = eip712_1.generateTypes(eip712_1.MSG_DELEGATE_TYPES);
                    msgs = [];
                    ...
                    //const valPubkey = "j5IQzvcfa/+lKXWiMBu7vCwlQDINoQfMgjBvD+5F6rQ="; 
                    // msgs.push(
                    ...
                    //     "evmosvaloper1su72g0q6qrun75e3nf7wq5hm95590g997dl2dt",
                    //     "1000000000000000001",
                    //     "stake",
                    //     valPubkey
                    //   )
                    // );
                    msgs.push(eip712_1.createMsgDelegate(sender.accountAddress, "evmosvaloper1can8phtx6t6aq73p3c2ad2l3dwhmewxe0tegst", "1000000000000000001", "stake"));
                    ...
                    //   )
                    // );
                    protoMsgs.push(proto_1.createMsgDelegate(sender.accountAddress, "evmosvaloper1can8phtx6t6aq73p3c2ad2l3dwhmewxe0tegst", "1000000000000000001", "stake"));
